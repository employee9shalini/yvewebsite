/**
 * Created by Narendra Kumar on 29/08/14.
 */
/*
...
(function() {
    ...
    function Y(a, b, c) {
        var d, e;
        if (Qa(b)) t(c) ? a.setAttribute(b, c) : a && a.getAttribute && (e = a.getAttribute(b));
        else if (t(b) &&
            ga(b))
    ...
    var r, D = document,
        ...
        Rb = S.opera,
        Ja = /msie/i.test(Fa) && !Rb,
        nb = D.documentMode === 8,
        Db = /AppleWebKit/.test(Fa),
        bb = /Firefox/.test(Fa),
        eb = /(Mobile|Android|Windows Phone)/.test(Fa),
        Ga = "http://www.w3.org/2000/svg",
        da = !! D.createElementNS && !! D.createElementNS(Ga, "svg").createSVGRect,
        Xb = bb && parseInt(Fa.split("Firefox/")[1],
            10) < 4,
        ka = !da && !Ja && !! D.createElement("canvas").getContext,
        Ya, cb, Sb = {}, Eb = 0,
        jb, F, wa, Ea, Fb, H, oa, pa = function() {
            return r
        }, ba = [],
        fb = 0,
        Va = "div",
        ...
        Yb = /^[0-9]+$/,
        Zb = "stroke-width",
        kb, Na, xb, yb, zb, Wa, lb, mb, Mb, Nb, Ab, Ob, Pb, B = {}, Q;
    ...
    Z.prototype = {
        ...
        show: function(a) {
            return a && this.element.namespaceURI === Ga ? (this.element.removeAttribute("visibility"), this) : this.attr({
        ...
        add: function(a) {
            ...
            if (c.handleZ) {
                ...
                for (g = 0; g < a.length; g++)
                    if (b = a[g], c = Y(b, "zIndex"), b !== e && (G(c) > f || !t(f) && t(c))) {
                        d.insertBefore(e, b);
                        h = !0;
                        break
                    }
    ...
    la.prototype = {
        ...
        buildText: function(a) {
            ...
            !f && !n && e.indexOf(" ") === -1 ? b.appendChild(D.createTextNode(e)) : (h = /<.*style="([^"]+)".*>/, i = /<.*href="(http[^"]+)".*>/, l && !a.added && this.box.appendChild(b), e = f ? e.replace(/<(b|strong)>/g, '<span style="font-weight:bold">').replace(/<(i|em)>/g, '<span style="font-style:italic">').replace(/<a/g, "<span").replace(/<\/(b|strong|i|em|a)>/g, "</span>").split(/<br.*?>/g) : [e], e[e.length - 1] === "" && e.pop(), p(e, function(e, f) {
                ...
                p(g, function(e) {
                    if (e !== "" || g.length === 1) {
                        var n = {}, o = D.createElementNS(Ga, "tspan"),
                            I;
                        ...
                        if (e !== " ") {
                            ...
                            if (l)
                                for (var e = e.replace(/([^\^])-/g, "$1- ").split(" "), n = g.length > 1 || e.length > 1 && k.whiteSpace !== "nowrap", q, p, r = k.HcHeight, u = [], t = y(o), Tb =
                                    1; n && (e.length || u.length);) delete a.bBox, q = a.getBBox(), p = q.width, !da && c.forExport && (p = c.measureSpanWidth(o.firstChild.data, a.styles)), q = p > l, !q || e.length === 1 ? (e = u, u = [], e.length && (Tb++, r && Tb * t > r ? (e = ["..."], a.attr("title", a.textStr)) : (o = D.createElementNS(Ga, "tspan"), Y(o, {
                                    dy: t,
                                    x: j
                                }), I && Y(o, "style", I), b.appendChild(o))), p > l && (l = p)) : (o.removeChild(o.firstChild), u.unshift(e.pop())), e.length && o.appendChild(D.createTextNode(e.join(" ").replace(/- /g, "-")));
                            m++
                        }
                    }
                })
        ...
        button: function(a, b, c, d, e, f, g, h, i) {
            var j =
                    this.label(a, b, c, i, null, null, null, null, "button"),
                k = 0,
                l, m, n, o, y, I, a = {
                    x1: 0,
                    y1: 0,
    ...
    if (!da && !ka) fa = {
        ...
        color: function(a, b, c, d) {
            ...
            if (i) {
                ...
                if (c === "fill")
                    if (i === "gradient") c = m.x1 || m[0] || 0, a = m.y1 || m[1] || 0, n = m.x2 || m[2] || 0, m = m.y2 || m[3] || 0, w = 'angle="' + (90 - X.atan((m - a) / (n - c)) * 180 / ta) + '"', v();
                    else {
                        var j = m.r,
                            t = j * 2,
                            s = j * 2,
            ...
            } else if (g.test(a) && b.tagName !== "IMG") f = Ha(a), h = ["<", c, ' opacity="', f.get("a"), '"/>'], aa(this.prepVML(h), null, null, b), j = f.get("rgb");
            else {
    ...
    ab.prototype = {
        ...
        render: function(a, b, c) {
            ...
            if (m && p) db === "inside" && (p = -p), d.opposite && (p = -p), h = this.getMarkPath(x, s, p, m * C, g, f), n ? n.animate({
                d: h,
                opacity: c
    ...
    Q.PlotLineOrBand.prototype = {
        render: function() {
            ...
            if (n)
                ...
                } else if (o && o.length && (a.svgElem = n = u.path(o).attr(r).add(), w))
    ...
    J.prototype = {
        ...
        defaultLabelFormatter: function() {
            ...
            if (h) g = La(h, this);
                ...
                for (; f-- && g === r;) c = Math.pow(1E3, f + 1), a >= c && e[f] !== null && (g = Ka(b / c, -1) + e[f]);
        ...
        getOffset: function() {
            ...
            if (j || a.isLinked) {
                ...
                for (u in f) f[u].destroy(), delete f[u]; if (o && o.text && o.enabled !== !1) {
        ...
        render: function() {
            var a = this,
                ...
                q = a.tickmarkOffset,
                qa = f.lineWidth,
                w = d.hasRendered && t(a.oldMin) && !isNaN(a.oldMin),
                u = a.hasData,
                v = a.showAxis,
                s, x = f.labels.overflow,
                A = a.justifyLabels = b && x !== !1,
                z;
            ...
            if (u || h)
                if (a.minorTickInterval && !a.categories && p(a.getMinorTickPositions(), function(b) {
                    ...
                    if (c % 2 === 0 && b < a.max) n[b] || (n[b] = new Q.PlotLineOrBand(a)), s = b + q, z = i[c + 1] !== r ? i[c + 1] + q : a.max, n[b].options = {
                        from: g ? ra(s) : s,
                        to: g ? ra(z) : z,
                        color: y
            ...
            if (qa) b = a.getLinePath(qa), a.axisLine ? a.axisLine.animate({
                d: b
        ...
        drawCrosshair: function(a, b) {
            if (this.crosshair)
                if ((t(b) || !q(this.crosshair.snap, !0)) === !1) this.hideCrosshair();
                else {
    ...
    J.prototype.getLogTickPositions = function(a, b, c, d) {
        ...
        if (a >= 0.5) a = u(a), g = this.getLinearTickPositions(a, b, c);
            ...
            } else if (b = ra(b), c = ra(c), a = e[d ? "minorTickInterval" : "tickInterval"], a = q(a === "auto" ? null : a, this._minorAutoInterval, (c - b) * (e.tickPixelInterval / (d ? 5 : 1)) / ((d ? f / this.tickPositions.length : f) || 1)), a = vb(a, null, ub(a)), g = za(this.getLinearTickPositions(a, b, c), Ia), !d) this._minorAutoInterval = a / 5;
    ...
    Za.prototype = {
        ...
        runPointActions: function(a) {
            ...
            if (d && this.options.tooltip.shared && (!h || !h.noSharedTooltip)) {
                ...
                i = c.length;
                for (j = 0; j < i; j++)
                    if (c[j].visible && c[j].options.enableMouseTracking !== !1 && !c[j].noSharedTooltip && c[j].singularTooltips !== !0 && c[j].tooltipPoints.length && (e = c[j].tooltipPoints[l]) && e.series) e._dist = P(l - e.clientX), k = A(k, e._dist), f.push(e);
        ...
        onContainerClick: function(a) {
            ...
            b.cancelClick || (c && this.inClass(a.target, "highcharts-tracker") ? (N(c.series, "click", s(a, {
                point: c
            })), b.hoverPoint && c.firePointEvent("click", a)) : (s(a, this.getCoordinates(a)), b.isInsidePlot(a.chartX - d, a.chartY - e) && N(b, "click", a)))
        },
    ...
    if (S.PointerEvent || S.MSPointerEvent) {
        var Aa = {}, Jb = !! S.PointerEvent,
            fc = function() {
                ...
                a = a.originalEvent || a;
                if ((a.pointerType === "touch" || a.pointerType === a.MSPOINTER_TYPE_TOUCH) && ba[ua]) d(a), d = ba[ua].pointer, d[b]({
                    type: c,
    ...
    rb.prototype = {
        ...
        renderItem: function(a) {
            ...
            if (!p) {
                ...
                a.legendItem = p = c.text(d.labelFormat ? La(d.labelFormat, a) : d.labelFormatter.call(a),
                        l ? f + g : -g, this.baseline || 0, s).css(x(a.visible ? h : i)).attr({
                        align: l ? "left" : "right",
                        zIndex: 2
                    }).add(a.legendGroup);
        ...
        scroll: function(a, b) {
            var c = this.pages,
                ...
                j = this.padding;
            e > d && (e = d);
            if (e > 0) b !== r && $a(b, this.chart), this.nav.attr({
                translateX: j,
    ...
    T = Q.LegendSymbolMixin = {
        ...
        drawLineMarker: function(a) {
            ...
            var e = this.chart.renderer,
                f = this.legendGroup,
                a = a.baseline - u(e.fontMetrics(a.options.itemStyle.fontSize, this.legendItem).b * 0.3),
                g;
            if (b.lineWidth) {
                g = {
    ...
    xa.prototype = {
        ...
        layOutTitles: function(a) {
            ...
            d && (d.css({
                ...
                }, e), !1, "spacingBox"), !e.floating && !e.verticalAlign && (b = Xa(b + d.getBBox().height)));
        ...
        cloneRenderTo: function(a) {
            var b = this.renderToClone,
                c = this.container;
            a ? b && (this.renderTo.appendChild(c), Ua(b), delete this.renderToClone) : (c && c.parentNode === this.renderTo && this.renderTo.removeChild(c), this.renderToClone = b = this.renderTo.cloneNode(0), K(b, {
                position: "absolute",
                top: "-9999px",
                display: "block"
        ...
        drawChartBox: function() {
            ...
            if (k) f ? f.animate(w) : this.plotBackground = b.rect(o, y, q, p, 0).attr({
                fill: k
    ...
    L.prototype = {
            ...
            if (d !== !1 && h && g === h && !e.cropped && !e.hasGroupedData) p(a, function(a, b) {
                ...
                if (o && h > o) {
                    ...
                    if (ma(k)) {
                        ...
                        if (u)
                            for (c = 0; c < h; c++) i = a[c], y[c] = i[0], I[c] = i.slice(1, u + 1);
                        else
                            for (c = 0; c < h; c++) i = a[c], y[c] = i[0], I[c] = i[1];
                    else oa(12)
                } else
                    for (c = 0; c < h; c++)
                        if (a[c] !== r && (i = {
                            series: e
                        }, e.pointClass.prototype.applyOptions.apply(i, [a[c]]), e.updateParallelArrays(i, c), m && i.name)) l.names[i.x] = i.name; Qa(I[0]) && oa(14, !0);
                e.data = [];
                e.options.data = a;
                for (c = g; c--;) f[c] &&
        ...
        processData: function(a) {
            ...
            if (l && this.sorted && (!j || d > j || this.forceCrop))
                if (m = h.getExtremes(), n = m.min, m = m.max, b[d - 1] < n || b[0] > m) b = [], c = [];
                else if (b[0] < n || b[d - 1] > m) e = this.cropData(this.xData,
        ...
        drawPoints: function() {
            ...
            var l = this.pointAttr[""],
                ...
                o = q(d.enabled, this.activePointCount <
                    0.5 * this.xAxis.len / d.radius);
            if (d.enabled !== !1 || this._hasPointMarkers)
                for (f = b.length; f--;)
                    if (g = b[f], d = V(g.plotX), e = g.plotY, k = g.graphic, i = g.marker || {}, a = o && i.enabled === r || i.enabled, m = c.isInsidePlot(u(d), e, c.inverted), a && e !== r && !isNaN(e) && g.y !== null)
                        if (a = g.pointAttr[g.selected ? "select" : ""] || l, h = a.r, i = q(i.symbol, this.symbol), j = i.indexOf("url") === 0, k) k[m ? "show" : "hide"](!0).animate(s({
                            x: d - h,
                            y: e - h
                        }, k.symbolName ? {
                            width: 2 * h,
    ...
    L.prototype.setPercentStacks = function() {
        ...
        p([b, "-" + b], function(b) {
            ...
            for (var f = d.length, g, h; f--;)
                if (g = d[f], e = (h = c[b] && c[b][g]) && h.points[a.index + "," + f], g = e) h = h.total ? 100 / h.total : 0, g[0] = ia(g[0] * h), g[1] = ia(g[1] * h), a.stackedYData[f] = g[1]
        })
    };
    s(xa.prototype, {
        addSeries: function(a, b, c) {
            var d, e = this;
            a && (b = q(b, !0), N(e, "addSeries", {
                options: a
            }, function() {
                d = e.initSeries(a);
                e.isDirtyLegend = !0;
    ...
    Ca = ha(L, {
        ...
        translate: function() {
            ...
            p(a.points, function(c) {
                var d = q(c.yBottom, f),
                    h = A(v(-999 - d, c.plotY), e.len + 999 + d),
                    p = c.plotX + k,
                    r = j,
                    w = A(h, d),
                    s;
        ...
        drawPoints: function() {
            ...
            p(a.points, function(h) {
                ...
                if (i !== r && !isNaN(i) && h.y !== null) f = h.shapeArgs, i = t(a.borderWidth) ? {
                    ...
                    "select" : ""] || a.pointAttr[""], j ? (gb(j), j.attr(i)[b.pointCount < e ? "animate" : "attr"](x(f))) : h.graphic = d[h.shapeType](f).attr(g).attr(i).add(a.group).shadow(c.shadow, null, c.stacking && !c.borderRadius);
    ...
    E = {
        ...
        translate: function(a) {
            ...
            var b = 0,
                ...
                i = (this.endAngleRad = ta / 180 * (q(c.endAngle, i + 360) - 90)) - j,
                k = this.points,
    ...
    L.prototype.alignDataLabel = function(a, b, c, d, e) {
        var f = this.chart,
            ...
            i = q(a.plotY, -999),
            j = b.getBBox();
        if (a = this.visible && (a.series.forceDL || f.isInsidePlot(h, u(i), g) || d && f.isInsidePlot(h, g ? d.x + 1 : d.y + d.height - 1, g))) d = s({
            x: g ? f.plotWidth - i : h,
            ...
            align: c.align
        }) : (b.align(c, null, d), g = b.alignAttr, q(c.overflow, "justify") === "justify" ? this.justifyDataLabel(b, c, g, j, d, e) : q(c.crop, !0) && (a = f.isInsidePlot(g.x, g.y) && f.isInsidePlot(g.x +
        ...
        function() {
            ...
            if (a.visible && (e.enabled || a._hasPointLabels)) {
                        ...
                        if (m > 0) {
                            ...
                            for (C = 0; C < J; C++) {
                                ...
                                if (E < C && B[C] !== null) E = C;
                                    ...
                                    for (w < J - C + E && B[C] !== null && (E = w - J + C); B[E] === null;) E++;
                                K.push({
                                    i: E,
                                    y: B[E]
                                });
                ...
                if (Da(R) === 0 || this.verifyDataLabelOverflow(R)) this.placeDataLabels(), r && g && p(this.points, function(b) {
                    j = b.connector;
                    t = b.labelPos;
                    if ((s = b.dataLabel) && s._pos) D = s._attr.visibility, z = s.connX, O = s.connY, k = l ? ["M", z + (t[6] === "left" ? 5 : -5), O, "C", z, O, 2 * t[2] - t[4], 2 * t[3] - t[5], t[2], t[3], "L", t[4], t[5]] : ["M", z + (t[6] === "left" ? 5 : -5), O, "L", t[2], t[3], "L", t[4], t[5]], j ? (j.animate({
                        d: k
    ...
    s(xa.prototype, {
        ...
        zoom: function(a) {
            ...
            else if (!d && ga(e)) this.resetZoomButton = e.destroy();
        ...
        if (c.options.ordinal && c.series.length) {
            ...
            if (m.ordinalPositions) {
                if (P(f) > 1) k &&
                    p(k, function(a) {
                        a.setState()
                    }), f < 0 ? (k = m, o = c.ordinalPositions ? c : m) : (k = c.ordinalPositions ? c : m, o = m), m = o.ordinalPositions, h > m[m.length - 1] && m.push(h), this.fixedRange = j - i, f = c.toFixedRange(null, null, l.apply(k, [n.apply(k, [i, !0]) + f, !0]), l.apply(o, [n.apply(o, [j, !0]) + f, !0])), f.min >= A(g.dataMin, i) && f.max <= v(h, j) && c.setExtremes(f.min, f.max, !0, !1, {
                    trigger: "pan"
        ...
        drawPoints: function() {
            ...
            p(a.points, function(k) {
                if (k.plotY !== r) i = k.graphic, c = k.pointAttr[k.selected ? "selected" : ""] || a.pointAttr[""], f = c["stroke-width"] % 2 / 2, j = u(k.plotX) - f, g = u(k.shapeArgs.width /
                    2), h = ["M", j, u(k.yBottom), "L", j, u(k.plotY)], k.open !== null && (d = u(k.plotOpen) + f, h.push("M", j, d, "L", j - g, d)), k.close !== null && (e = u(k.plotClose) + f, h.push("M", j, e, "L", j + g, e)), i ? i.animate({
                    d: h
        ...
        drawPoints: function() {
            ...
            p(a.points, function(p) {
                ...
                if (p.plotY !== r) c = p.pointAttr[p.selected ? "selected" : ""] ||
                    d, k = c["stroke-width"] % 2 / 2, l = u(p.plotX) - k, e = p.plotOpen, f = p.plotClose, g = X.min(e, f), h = X.max(e, f), o = u(p.shapeArgs.width / 2), i = u(g) !== u(p.plotY), j = h !== p.yBottom, g = u(g) + k, h = u(h) + k, n = ["M", l - o, h, "L", l - o, g, "L", l + o, g, "L", l + o, h, "Z", "M", l, g, "L", l, i ? u(p.plotY) : g, "M", l, h, "L", l, j ? u(p.yBottom) : h], m ? m.animate({
                    d: n
    ...
    B.flags = ha(B.column, {
        ...
        drawPoints: function() {
            var a, b = this.pointAttr[""],
                ...
                n, o;
            for (j = c.length; j--;)
                if (k = c[j], a = k.plotX > this.xAxis.len, e = k.plotX + (a ? m : -m), l = k.stackIndex, i = k.options.shape || g.shape, f = k.plotY, f !== r && (f = k.plotY + h + m - (l !==
                    r && l * g.stackDistance)), n = l ? r : k.plotX + m, o = l ? r : k.plotY, l = k.graphic, f !== r && e >= 0 && !a) a = k.pointAttr[k.selected ? "select" : ""] || b, l ? l.attr({
                    x: e,
                    y: f,
                    r: a.r,
                    anchorX: n,
    ...
    Bb.prototype = {
        ...
        drawScrollbarButton: function(a) {
            ...
            }).add(d[a]), c.push(g), g = b.path(["M", e / 2 + (a ? -1 : 1), e / 2 - 3, "L", e / 2 + (a ? -1 : 1), e /
                    2 + 3, e / 2 + (a ? 2 : -2), e / 2
                ]).attr({
            ...
            if (!isNaN(a)) {
                ...
                if (!(l.translate(d, !0) - l.translate(c, !0) < e.xAxis[0].minRange)) {
                    ...
                    if (p && k) this.drawScrollbarButton(0), this.drawScrollbarButton(1), k[e]({
                        ...
                        width: j
                    }), g = o + b, h = a - F, h < w && (D = (w - h) / 2, h = w, g -= D), this.scrollbarPad = D, m[e]({
                        x: V(g) + F % 2 / 2,
                        width: h
        ...
        init: function() {
            ...
            a.mouseDownHandler = function(d) {
                ...
                if (t > h && t < h + g + j)
                    if ((h = !a.scrollbarEnabled || t < h + g) && X.abs(s - e - o) < v) a.grabbedLeft = !0, a.otherHandlePos = f, a.fixedExtreme = d.max, b.fixedRange = null;
                    else if (h && X.abs(s - f - o) < v) a.grabbedRight = !0, a.otherHandlePos = e, a.fixedExtreme = d.min, b.fixedRange = null;
                        ...
                        if (f !== e) a.fixedWidth =
                            r, e = c.toFixedRange(f, f + r, null, u), d.setExtremes(e.min, e.max, !0, !1, {
                            trigger: "navigator"
                        })
                    }
            };
            ...
            a.navigatorEnabled ? (a.xAxis = c = new J(b, x({
                ...
                index: o,
                zoomEnabled: !1
            })), m || f.series.data ? a.addBaseSeries() : b.series.length ===
        ...
        addBaseSeries: function() {
            ...
            if (a && this.navigatorOptions.adaptToUpdatedData !== !1) z(a,
                "updatedData", this.updatedDataHandler), a.userOptions.events = s(a.userOptions.event, {
    ...
    Cb.prototype = {
        clickButton: function(a, b) {
            var c = this,
                ...
                g = c.buttonOptions[a],
                h = e.xAxis[0],
                i = e.scroller && e.scroller.getUnionExtremes() || h || {}, j = i.dataMin,
                k = i.dataMax,
                l, m = h && u(A(h.max, q(k, h.max))),
                n = new Date(m),
                o = g.type,
                s = g.count,
                i = g._range,
