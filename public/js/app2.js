;(function(window, $) {
    ...
    $(function() {
        ...
        function chooserecipient(qb_id, qb_login)
        {
...
alert(recp_id);
                ...
                app.callees[user.id]=recp_id;
                app.callees[user.full_name]=uname;
...
//alert(app.currentSession);
        ...
        QB.webrtc.onUserNotAnswerListener = function onUserNotAnswerListener(session, userId) {
          ...
          if(session.opponentsIDs.length === 1) {
              $(".msg_board").show();
              qbApp.MsgBoard.update('User not answer');
        ...
        QB.webrtc.onCallListener = function onCallListener(session, extension) {
           ...
           var userInfo = '';
            ...
            /** set name of caller */
            $('.j-ic_initiator').text( app.caller.full_name);
